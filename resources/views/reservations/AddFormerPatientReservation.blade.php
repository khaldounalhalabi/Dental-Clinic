...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 class="myfont">إضافة الحجز</h1>
    </div><!-- End Page Title -->
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body pt-3">
                        <!-- add reservation -->
                        @if($patient)
                        <form action="{{ route('add.reservation' , [$patient->id]) }}" method="post">
                            @csrf

                            <div class="row mb-3">
                                <label for="patient_id" class="col-md-4 col-lg-3 col-form-label myfont"><a
                                        href="{{ URL::route('add.reservation' , [$patient->id]) }}">ID</a></label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="patient_id" type="text" class="form-control myfont" id="patient_id"
                            ...
                            <div class="row mb-3">
                                <label for="first_name" class="col-md-4 col-lg-3 col-form-label myfont">الاسم
                                    الأول</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="first_name" type="text" class="form-control myfont" id="first_name"
                                        value="{{ $patient->first_name }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="home_number" class="col-md-4 col-lg-3 col-form-label myfont">رقم
                                    الهاتف</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="home_number" type="text" class="form-control myfont" id="home_number"
                                        value="{{ $patient->home_number }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="phone_number" class="col-md-4 col-lg-3 col-form-label myfont">رقم
                                    الجوال</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="phone_number" type="text" class="form-control myfont" id="phone_number"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="reason" type="text" class="form-control myfont" id="reason"
                                        value="">
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="notes" class="col-md-4 col-lg-3 col-form-label myfont">ملاحظات</label>
                                <div class="col-md-8 col-lg-9">
